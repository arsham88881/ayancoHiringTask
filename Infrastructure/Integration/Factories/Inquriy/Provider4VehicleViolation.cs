...
public class Provider4VehicleViolation : IInquiryVehicleViolation
{
    private readonly IHttpIntegrationContext _httpIntegrationContext;

    public Provider4VehicleViolation(
        ...
        CancellationToken ct = default)
    {
        ...
        var response = await _httpIntegrationContext.PostAsync<Provider4Response>(
    ...
    private class Provider4Response
    {
        public bool Success { get; set; }
        public string? Provider { get; set; }
        public string? Message { get; set; }
        public Provider4Data? Data { get; set; }
    }

    private class Provider4Data
    {
