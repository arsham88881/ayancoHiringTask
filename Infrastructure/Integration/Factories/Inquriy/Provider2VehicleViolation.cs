...
public class Provider2VehicleViolation : IInquiryVehicleViolation
{
    private readonly IHttpIntegrationContext _httpIntegrationContext;

    public Provider2VehicleViolation(
        ...
        CancellationToken ct = default)
    {
        ...
        var response = await _httpIntegrationContext.PostAsync<Provider2Response>(
    ...
    private class Provider2Response
    {
        public bool Success { get; set; }
        public string? Provider { get; set; }
        public string? Message { get; set; }
        public Provider2Data? Data { get; set; }
    }

    private class Provider2Data
    {
