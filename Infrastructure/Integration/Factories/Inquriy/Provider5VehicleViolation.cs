...
public class Provider5VehicleViolation : IInquiryVehicleViolation
{
    private readonly IHttpIntegrationContext _httpIntegrationContext;

    public Provider5VehicleViolation(
        ...
        CancellationToken ct = default)
    {
        ...
        var response = await _httpIntegrationContext.PostAsync<Provider5Response>(
    ...
    private class Provider5Response
    {
        public bool Success { get; set; }
        public string? Provider { get; set; }
        public string? Message { get; set; }
        public Provider5Data? Data { get; set; }
    }

    private class Provider5Data
    {
